          ...
          child: SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                const Align(alignment: AlignmentDirectional.centerStart, child: _ProductDetailsBackButton()),
              ],
            ),
          ),
        ),
...
class _ProductDetailsBackButton extends StatelessWidget {
  const _ProductDetailsBackButton();
