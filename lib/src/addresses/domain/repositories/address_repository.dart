...
import '../usecases/get_address_use_case.dart';
...
abstract class AddressRepository {
  ...
  DomainServiceType<LocationEntity> getAddress(GetAddressParams params);
  ...
  DomainServiceType<LocationEntity> setDefaultAddress(SetDefaultAddressParams params);
