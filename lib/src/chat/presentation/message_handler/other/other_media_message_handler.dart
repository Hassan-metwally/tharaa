...
class OtherMediaMessageHandler extends Equatable implements ChatMessageHandler {
  @override
  final ChatMessageEntity message;

  const OtherMediaMessageHandler({required this.message});
  ...
  Widget getMessageWidget({ChatMessageCallback? onLongPressed, ChatMessageCallback? onPressed}) {
    ...
    return Row(
      ...
      children: [
        Flexible(
          child: Container(
            decoration: ChatDecorationConstants.otherCellDecoration,
